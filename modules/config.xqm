...
(:
 ...
 :)
declare variable $config:default-view :="simple";
...
(:~
 ...
 :)
declare variable $config:default-odd :="drama.odd";
...
(:~
 ...
 :)
declare variable $config:odd-available :=("drama.odd", "annotations.odd");
